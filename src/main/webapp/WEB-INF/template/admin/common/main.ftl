                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                    	[#if acl.children?has_content]
	                    	<a href="javascript:;">
	                            <i class="${acl.icon}"></i>
	                            <span class="nav-label"> ${acl.aclName}</span>
	                        ...
	                        <ul class="nav nav-second-level">
	                        	[#list acl.children as a]
		                            ...
		                            <li>
		                                <a class="J_menuItem" href="javascript:;" data-href="${base}${a.url}">[#if a.icon??]<i class="${a.icon}"></i>[/#if]${a.aclName}</a>
		                            </li>
		                            [/@shiro.hasPermission]
	                            [/#list]
	                        </ul>
                    	[#else]
                    		<a class="J_menuItem" href="javascript:;" data-href="${base}${acl.url}"><i class="${acl.icon}"></i> <span class="nav-label">${acl.aclName}</span></a>
                    	[/#if]
                    </li>
                    [/@shiro.hasPermission]
                    [/#list]
