    ...
    <div class="col-md-7 col-sm-12">
		...
		[#if totalPages > 1]
            <ul class="pagination" style="visibility: visible;">
				...
				[#if pageNumber < 3]
					[#list 1..totalPages as segmentPageNumber ]
				...
				[#elseif pageNumber > totalPages-2 ]
					[#list totalPages-4..totalPages as segmentPageNumber ]
						[#if segmentPageNumber<1]
						[#elseif segmentPageNumber != pageNumber]
                            <li>
                                <a href="javascript: $.pageSkip(${segmentPageNumber});">${segmentPageNumber}</a>
                            </li>
						[#else]
