                  	...
                  	<div class="ibox-content">
                  		...
                  		<div class="form-group">
                       		<div class="row">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" name="aclName" id="aclName" class="form-control">
	                                </div>
                       			 </div>
                       			 <div class="col-sm-6">
                       			 	<label class="col-sm-3 control-label"><span class="required"> * </span>资源类型</label>
	                                <div class="col-sm-9">
	                                    <select name="aclType" id="aclType" data-placeholder="选择类型..." class="chosen-select"  style="width:350px;" >
                       			...
                       			<div class="col-sm-6">
	                                ...
	                                <div class="col-sm-9">
	                                     <select name="parentId" id="parentId" data-placeholder="上级资源..." class="chosen-select"  style="width:350px;" >
	                                     	...
	                                     	[#list acls as acl]
	                                 			<option  hassubinfo="true" value="${acl.id}">${acl.aclName}</option>
	                                 			[#list acl.children as child]
	                                 			<option  hassubinfo="true" value="${child.id}">&nbsp;&nbsp;&nbsp;&nbsp;├ &nbsp;${child.aclName}</option>
	                                 			[/#list]
	                                 		[/#list]
										</select>
	                                </div>
