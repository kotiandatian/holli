...
<div class="form-group">
	<div class="row">
		 <div class="col-sm-6">
            ...
            <div class="col-sm-9">
                <input type="text" name="name" id="name" value="${acl.aclName}" class="form-control">
            </div>
		 </div>
		 <div class="col-sm-6">
            ...
            <div class="col-sm-9">
                 <select name="parentId" id="parentId" data-placeholder="上级资源..." class="chosen-select"  style="width:350px;" >
                 	...
                 	[#list acls as a]
             			...
             			<option  hassubinfo="true" value="${child.id}" [#if acl.id == child.id]selected[/#if]>-----${child.aclName}</option>
             			[/#list]
             		[/#list]
				</select>
            </div>
