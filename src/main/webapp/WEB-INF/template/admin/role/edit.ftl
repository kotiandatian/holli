                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="name" id="name" value="${role.roleName}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <label class="col-sm-3 control-label">描述</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="description" value="${role.descriptions}" id="description" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-9">
									...
									[#list roots as root]
										...
										[#list root.childs as child]
                                            ...
                                            <br>
											[#list child.childs as btn]
                                                <div class="checkbox-inline i-checks" style="margin-left:60px;">
                                                    <input type="checkbox" class="i-checks" name="ids" value="${btn.id}"  [#if role.aclIds?seq_contains(btn.id)]checked[/#if]>${btn.aclName}
                                                </div>
                                                <br>
											[/#list]
										[/#list]
