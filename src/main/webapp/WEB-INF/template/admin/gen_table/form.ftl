				                        ...
				                        <table class="table" style="margin-bottom:0px;">
				                            ...
				                            <tbody>
				                                ...
				                                <tr>
				                                    ...
				                                    <td><input type="checkbox" value="1" [#if column.pri == true]checked[/#if]  name="columns[${column_index}].isPk"></td>
				                                    <td><input type="checkbox" value="1" [#if column.null == true]checked[/#if]  name="columns[${column_index}].isNull"></td>
				                                    <td><input type="checkbox" value="1" checked  name="columns[${column_index}].isInsert"></td>
				                                    <td><input type="checkbox" value="1" checked  name="columns[${column_index}].isEdit"></td>
				                                    <td><input type="checkbox" value="1" checked name="columns[${column_index}].isList"></td>
				                                    <td><input type="checkbox" value="1" checked name="columns[${column_index}].isQuery"></td>
				                                     <td>
													...
													<td>
														<input type="text" name="columns[${column_index}].sorts" value="${(column_index + 1) * 10}" maxlength="200" class="form-control" style="width:60px;">
													</td>
				                                </tr>
				                                [/#list]
				                            </tbody>
