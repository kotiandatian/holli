...
public class GenTableController extends GenericController {
	...
	public String save(HttpServletRequest request,GenTable table, RedirectAttributes redirectAttributes) {
		...
		scheme.setSchemeName(table.getDescription());
		scheme.setSchemeTemplate("5");//生成全部
	 ...
	 */
	 ...
	 public @ResponseBody Message delete(Long[] ids) {
		...
		tableService.deleteMangByIds(ids);
