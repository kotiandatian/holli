...
//			}
		...
		if (username != null && password != null) {
			...
			return new SimpleAuthenticationInfo(new Principal(user.getId(),StringUtils.isEmpty(user.getNickname())?username:user.getNickname(),role.getRoleName(),user.getAvatar()), password, getName());
		}
		throw new UnknownAccountException();
	}
