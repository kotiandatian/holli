...
public class WeiXinSignAndPackage {
	...
	public static String createPackage(TreeMap<String,String> treeMap){
		...
		String stringSignTemp = string1 + "key="+AzuraWechatUtil.WECHAT_APP_PAY_SIGN_KEY;
	...
	public static String getPrepayId(TreeMap<String, String> payParamMap){
		String result=HttpTool.sendPost("https://api.mch.weixin.qq.com/pay/unifiedorder", payParamMap, "UTF-8");
		return result;
	}
}
