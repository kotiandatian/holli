...
public class ChinaInitial {
	...
	System.out.println("中文首字母："+getFirstStr("昵称"));

	}
    public static String getFirstStr(String strChinese){
    	return getPYIndexStr(strChinese.substring(0, 1),true).toUpperCase();
	 }
